    ...
    <script>
        ...
        function displayTrainingData(data) {
            ...
            for (var i = 0; i < trainings.length; i++) {
                ...
                row.insertCell(10).innerHTML = training.vlocation;
                row.insertCell(11).innerHTML = training.vcontactname;
                row.insertCell(12).innerHTML = training.vcontactmailid;
                row.insertCell(13).innerHTML = training.vcontactno;
                row.insertCell(14).innerHTML = training.vstate;
                row.insertCell(15).innerHTML = training.vdistrict;
                row.insertCell(16).innerHTML = training.vmandal;
                row.insertCell(17).innerHTML = training.actual_start_dt;
                row.insertCell(18).innerHTML = training.actual_end_dt;
                row.insertCell(19).innerHTML = training.training_reg_start_dt;
                row.insertCell(20).innerHTML = training.training_reg_end_dt;
